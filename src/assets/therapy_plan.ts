  ...
  "TherapyPlans": [
    {
      ...
      "Exercises": {
        "Memory": {
          "ConciseOverview": "Engage in memory recall activities starting simple and increasing in complexity over 9+ weeks.",
          "ExpandableDetails": [
            {
              "Phase": "Week 1-4",
        ...
        "Cognitive": {
          ...
          "ExpandableDetails": [
            ...
            {
              "Phase": "Week 5-8",
              "Description": "Incorporate more challenging cognitive tasks such as advanced puzzles, memory recall exercises, and strategy games for 20-30 minutes, 4-5 times a week, to build on your cognitive progress.",
              "Intensity": 4,
        ...
        "Balance": {
          ...
          "ExpandableDetails": [
            ...
            {
              "Phase": "Week 5-8",
              "Description": "Try incorporating more dynamic balance activities, such as gentle challenges and practice standing on unstable surfaces for 10-15 minutes, 3-4 times a week, to increase your balance and coordination skills.",
              "Intensity": 4,
              "Time": "10-15 min, 3-4 times/week"
            },
            {
              "Phase": "Week 9+",
              "Description": "Include more complex balance tasks like coordination exercises, such as reaching for objects while standing or using a balance board, for 15-20 minutes, 2-3 times a week. If you are not comfortable with using an exercise ball, please use a balance board or perform standing balance exercises instead.",
              "Intensity": 6,
